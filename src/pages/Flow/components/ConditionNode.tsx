...
import {
    ...
    BranchNodeTitleWrap,
    BranchNodeWrap,
    ConditionNodeTitleWrap,
} from '../flow.styles';
import AddNode from './Add';
import { NodeTypes } from './Constants';
import Render from './Render';
/** 条件节点 */
const ConditionNode = ({ conditionNodes: branches = [] as BranchItem[], ...restProps }) => {
    const { onAddNode, onDeleteNode, onSelectNode, handleOpenConditionDrawer, branchMove, copyBranch } =
        useContext(WFC);
